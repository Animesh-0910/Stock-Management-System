...
<ul class="vertical" >
	...
	<li class="vertical"><a class="active" href="cart_modify.php">Modify item in Cart</a></li>
	<!--<li class="vertical"><a href="item_search.php">Search Item</a></li> -->
</ul>
</div>
<br>
<div class="addItemForm">
<form id="additem" name="additem" action="cart_modified.php" method="post">
...
<div style="width:400px;margin: auto;background-color: #96c0d6;border-radius: 20px;align-content: center;"><center>
	...
	<form name="addtocart" action="cart_modified.php" method="post">
	<table class="selectItem" style="font-size: 18px;">
			...
			<tr>
				<td>Quantity to purchase:</span></td>
			...
			<tr>
				<td colspan="2" align="center"><button type="submit" name="modifycart" style="font-size: 18px;">Modify Item in Cart
					</button>
				</td>
			</tr>	
		</table>
