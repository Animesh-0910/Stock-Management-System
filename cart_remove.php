...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
	...
	<title>Stock Maintenence:Remove from Cart</title>
...
<ul class="vertical" >
	...
	<li class="vertical"><a class="active"  href="cart_remove.php">Remove from Cart</a></li>
...
<form id="additem" name="additem" action="cart_removed.php" method="post">
...
<div style="width:400px;margin: auto;background-color: #96c0d6;border-radius: 20px;align-content: center;"><center>
	<span style="style="font-size: 18px;"">Hello <?php echo($_SESSION['name'])?><br>Search the item that you want to remove from cart</span><br><br>
	<form name="addtocart" action="cart_removed.php" method="post">
	<table class="selectItem" style="font-size: 18px;">
			...
			<tr>
				...
				<td colspan="2" align="center"><button type="submit" name="removecart" style="font-size: 18px;">Remove from Cart
					</button>
				</td>
			</tr>	
		</table>
